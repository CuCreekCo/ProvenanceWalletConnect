...
/// MsgIBCSend
struct Cosmwasm_Wasm_V1beta1_MsgIBCSend {
...
struct Cosmwasm_Wasm_V1beta1_MsgIBCCloseChannel {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmwasm_Wasm_V1beta1_MsgIBCSend: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmwasm_Wasm_V1beta1_MsgIBCSend, rhs: Cosmwasm_Wasm_V1beta1_MsgIBCSend) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_MsgIBCCloseChannel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmwasm_Wasm_V1beta1_MsgIBCCloseChannel, rhs: Cosmwasm_Wasm_V1beta1_MsgIBCCloseChannel) -> Bool {
    if lhs.channel != rhs.channel {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
