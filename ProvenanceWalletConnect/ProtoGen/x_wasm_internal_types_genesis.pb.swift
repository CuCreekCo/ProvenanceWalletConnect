...
struct Cosmwasm_Wasm_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var params: Cosmwasm_Wasm_V1beta1_Params {
    get {return _params ?? Cosmwasm_Wasm_V1beta1_Params()}
  ...
  var codes: [Cosmwasm_Wasm_V1beta1_Code] = []

  var contracts: [Cosmwasm_Wasm_V1beta1_Contract] = []

  var sequences: [Cosmwasm_Wasm_V1beta1_Sequence] = []

  var genMsgs: [Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs] = []
  ...
  struct GenMsgs {
    ...
    var sum: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs.OneOf_Sum? = nil

    var storeCode: Cosmwasm_Wasm_V1beta1_MsgStoreCode {
      get {
        if case .storeCode(let v)? = sum {return v}
        return Cosmwasm_Wasm_V1beta1_MsgStoreCode()
      }
      set {sum = .storeCode(newValue)}
    }

    var instantiateContract: Cosmwasm_Wasm_V1beta1_MsgInstantiateContract {
      get {
        if case .instantiateContract(let v)? = sum {return v}
        return Cosmwasm_Wasm_V1beta1_MsgInstantiateContract()
      }
      set {sum = .instantiateContract(newValue)}
    }

    var executeContract: Cosmwasm_Wasm_V1beta1_MsgExecuteContract {
      get {
        if case .executeContract(let v)? = sum {return v}
        return Cosmwasm_Wasm_V1beta1_MsgExecuteContract()
      }
    ...
    enum OneOf_Sum: Equatable {
      case storeCode(Cosmwasm_Wasm_V1beta1_MsgStoreCode)
      case instantiateContract(Cosmwasm_Wasm_V1beta1_MsgInstantiateContract)
      case executeContract(Cosmwasm_Wasm_V1beta1_MsgExecuteContract)

    #if !swift(>=4.1)
      static func ==(lhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs.OneOf_Sum, rhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs.OneOf_Sum) -> Bool {
  ...
  fileprivate var _params: Cosmwasm_Wasm_V1beta1_Params? = nil
}

/// Code struct encompasses CodeInfo and CodeBytes
struct Cosmwasm_Wasm_V1beta1_Code {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var codeInfo: Cosmwasm_Wasm_V1beta1_CodeInfo {
    get {return _codeInfo ?? Cosmwasm_Wasm_V1beta1_CodeInfo()}
  ...
  fileprivate var _codeInfo: Cosmwasm_Wasm_V1beta1_CodeInfo? = nil
}

/// Contract struct encompasses ContractAddress, ContractInfo, and ContractState
struct Cosmwasm_Wasm_V1beta1_Contract {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var contractState: [Cosmwasm_Wasm_V1beta1_Model] = []
...
struct Cosmwasm_Wasm_V1beta1_Sequence {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmwasm_Wasm_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmwasm_Wasm_V1beta1_GenesisState, rhs: Cosmwasm_Wasm_V1beta1_GenesisState) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Cosmwasm_Wasm_V1beta1_GenesisState.protoMessageName + ".GenMsgs"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Cosmwasm_Wasm_V1beta1_MsgStoreCode?
        if let current = self.sum {
          try decoder.handleConflictingOneOf()
          if case .storeCode(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.sum = .storeCode(v)}
      }()
      case 2: try {
        var v: Cosmwasm_Wasm_V1beta1_MsgInstantiateContract?
        if let current = self.sum {
          try decoder.handleConflictingOneOf()
          if case .instantiateContract(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.sum = .instantiateContract(v)}
      }()
      case 3: try {
        var v: Cosmwasm_Wasm_V1beta1_MsgExecuteContract?
        if let current = self.sum {
          try decoder.handleConflictingOneOf()
          if case .executeContract(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.sum = .executeContract(v)}
      }()
      default: break
      }
    }
  ...
  static func ==(lhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs, rhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Code: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmwasm_Wasm_V1beta1_Code, rhs: Cosmwasm_Wasm_V1beta1_Code) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Contract: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmwasm_Wasm_V1beta1_Contract, rhs: Cosmwasm_Wasm_V1beta1_Contract) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Sequence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmwasm_Wasm_V1beta1_Sequence, rhs: Cosmwasm_Wasm_V1beta1_Sequence) -> Bool {
