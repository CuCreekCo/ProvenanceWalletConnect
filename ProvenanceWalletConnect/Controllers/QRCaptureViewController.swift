...
class QRCaptureViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func viewDidLoad() {
        ...
        previewLayer.frame = view.viewWithTag(0)!.layer.bounds
        previewLayer.videoGravity = .resizeAspectFill
        view.viewWithTag(0)!.layer.addSublayer(previewLayer)
    ...
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if let metadataObject = metadataObjects.first {
            ...
            found(metadata: readableObject)
        }

        dismiss(animated: true)
    }

    func found(metadata: AVMetadataMachineReadableCodeObject) {
