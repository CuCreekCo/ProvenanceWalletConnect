...
struct Provenance_Metadata_V1_MsgWriteSessionRequest {
  ...
  var session: Provenance_Metadata_V1_Session {
    get {return _session ?? Provenance_Metadata_V1_Session()}
  ...
  fileprivate var _session: Provenance_Metadata_V1_Session? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        if let v = v {self.scopeIdentifier = .scopeUuid(v)}
      }()
      case 2: try {
        if self.scopeIdentifier != nil {try decoder.handleConflictingOneOf()}
        var v: String?
        try decoder.decodeSingularStringField(value: &v)
        if let v = v {self.scopeIdentifier = .scopeAddr(v)}
      }()
