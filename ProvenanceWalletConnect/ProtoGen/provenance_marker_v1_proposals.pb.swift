...
struct Provenance_Marker_V1_SupplyIncreaseProposal {
  ...
  var targetAdddress: String = String()
...
extension Provenance_Marker_V1_SupplyIncreaseProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "description"),
    3: .same(proto: "amount"),
    4: .standard(proto: "target_adddress"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.description_p) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._amount) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.targetAdddress) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.targetAdddress.isEmpty {
      try visitor.visitSingularStringField(value: self.targetAdddress, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Provenance_Marker_V1_SupplyIncreaseProposal, rhs: Provenance_Marker_V1_SupplyIncreaseProposal) -> Bool {
    ...
    if lhs.description_p != rhs.description_p {return false}
    if lhs._amount != rhs._amount {return false}
    if lhs.targetAdddress != rhs.targetAdddress {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Provenance_Marker_V1_WithdrawEscrowProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "denom"),
    4: .same(proto: "amount"),
    5: .standard(proto: "target_adddress"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.targetAdddress) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.targetAdddress.isEmpty {
      try visitor.visitSingularStringField(value: self.targetAdddress, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
